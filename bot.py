...
async def start(message: types.Message):
    ...
    if token_db.get_balance(message.from_user.id) is None:
        ...
        await message.answer_photo(photo=photo_url, caption= "Привет!👋 Вы уже зарегистрированы в системе токенов. Добро пожаловать в нашего бота, созданного для обучения в онлайн! Здесь вы сможете:\n\n"
